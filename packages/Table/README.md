...
| --- | --- | --- | --- | --- |
| `tableCheckRef` | React.ForwardedRef | - | It exposes the following methods of the component:  <br /> <ol><li>`tableCheckRef.current.check([{index:1,value:true},{index:3,value:true}], (res) => { console.log(res) })`</li></ol> | - |
