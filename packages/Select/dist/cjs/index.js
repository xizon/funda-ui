...
var _excluded = ["wrapperClassName", "disabled", "required", "value", "label", "name", "id", "options", "style", "tabIndex", "fetchFuncAsync", "fetchFuncMethod", "fetchFuncMethodParams", "fetchResponseField", "onFetch", "onChange", "onBlur", "onFocus"];
...
var Select = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (props, ref) {
  ...
  var optionsRes = options ? options : '';
  ...
  if (dataInit.length > 0) {
    ...
    optionKeys = dataInit.map(function (item) {
      return item.label;
    });
    optionValues = dataInit.map(function (item) {
      return item.value;
    });
  } else {
  ...
  var selectOptionsList = optionKeys.map(function (selectOption, index) {
