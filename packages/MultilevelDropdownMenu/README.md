...
| `onSelect` | function  | - | Call a function when clicking an item. It returns two callback values. <br /> <ol><li>The first is the current item Event (**Event**)</li><li>The second is the data (**JSON Object**)</li></ol> | - |
