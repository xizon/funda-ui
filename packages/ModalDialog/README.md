...
| `onOpen` | function  | - | Call a function when the modal is opened. It returns two callback values. <br /> <ol><li>The first is is the trigger object (**React.MouseEvent\<HTMLElement\> \| null**)</li><li>The second is the function of close (**Function**)</li></ol> | - |
| `onClose` | function  | - | Call a function when the modal is closed. It returns one callback value. <br /> <ol><li>The first is is the trigger object (**React.MouseEvent\<HTMLElement\> \| null**)</li></ol> | - |
| `onSubmit` | function  | - | Call a function when the modal is submitted. It returns three callback values. <br /> <ol><li>The first is the trigger Event (**React.MouseEvent\<HTMLButtonElement\>**)</li><li>The second is the closing event (**Function**)</li><li> The third is a string passed by the `data` attribute</li></ol> | - |
| `onPressEnter` | function  | - | The callback function that is triggered when Enter key is pressed. It returns one callback value. <br /> <ol><li>The first is the function of close (**Function**)</li></ol> | - |
