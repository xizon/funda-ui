...
var _excluded = ["wrapperClassName", "disabled", "required", "value", "label", "placeholder", "name", "id", "columnTitle", "depth", "loader", "displayResult", "displayResultArrow", "controlArrow", "valueType", "style", "tabIndex", "triggerClassName", "triggerContent", "fetchFuncAsync", "fetchFuncMethod", "fetchFuncMethodParams", "callback", "onFetch", "onChange", "onBlur", "onFocus"];
...
var CascadingSelect = function CascadingSelect(props) {
  ...
  function _fetchData() {
    _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(params) {
      var response, _alldata, _EMPTY_SUPPORTED_DATA;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _EMPTY_SUPPORTED_DATA = JSON.parse(JSON.stringify(_alldata));
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement((external_root_React_commonjs2_react_commonjs_react_amd_react_default()).Fragment, null, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ...
    return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("li", {
      ...
      data: item,
      selectEv: function selectEv(value, index) {
        return handleClickItem(value, index, level);
      }
    }));
